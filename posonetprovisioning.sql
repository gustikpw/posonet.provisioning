...
-- Dumping database structure for posonetpendolo
CREATE DATABASE IF NOT EXISTS `posonetprovisioning` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `posonetprovisioning`;

-- Dumping structure for table posonetpendolo.detail_setoran
...
-- Dumping structure for table posonetpendolo.karyawan
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='Data karyawan';

-- Data exporting was unselected.

-- Dumping structure for table posonetpendolo.kolektor
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='Setiap kolektor mempunyai wilayah penagihan masing masing';

-- Data exporting was unselected.

-- Dumping structure for table posonetpendolo.log_temp_invoice
...
-- Dumping structure for table posonetpendolo.master_setoran
...
-- Dumping structure for table posonetpendolo.outbox
...
-- Dumping structure for table posonetpendolo.paket
...
-- Dumping structure for table posonetpendolo.pelanggan
...
-- Dumping structure for table posonetpendolo.pengeluaran
...
-- Dumping structure for table posonetpendolo.profil_perusahaan
...
-- Dumping structure for table posonetpendolo.serial_number
...
-- Dumping structure for table posonetpendolo.settings
...
-- Dumping structure for table posonetpendolo.statistik_bulanan
...
-- Dumping structure for table posonetpendolo.temp_invoice
...
-- Dumping structure for table posonetpendolo.tickets
...
-- Dumping structure for table posonetpendolo.users
...
-- Dumping structure for table posonetpendolo.u_olt_onu_type
...
-- Dumping structure for table posonetpendolo.u_reconfig_ont
...
-- Dumping structure for table posonetpendolo.u_router_ppp_profile
...
-- Dumping structure for view posonetpendolo.v_detail_setoran
...
-- Dumping structure for view posonetpendolo.v_expired
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_kolektor
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_master_setoran
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_onu_los
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_onu_offline
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_pelanggan
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_setoran
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_setoran_bulan_ini
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_temp_invoice
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for view posonetpendolo.v_users
-- Creating temporary table to overcome VIEW dependency errors
...
-- Dumping structure for table posonetpendolo.wilayah
...
-- Dumping structure for trigger posonetpendolo.temp_invoice_before_delete
